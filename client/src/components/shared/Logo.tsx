import React, {
  ...
  export const Logo: React.FC<LogoProps> = ({ onButtonClick, buttons }) => {
    ...
    useEffect(() => {
      animateLogo();
      setIsTextVisible(false); // Hide text immediately when state changes
    ...
    return (
      <div className="w-[500px] h-[600px] relative cursor-pointer flex items-center justify-center mt-[200px]">
        <svg
          ref={logoRef}
